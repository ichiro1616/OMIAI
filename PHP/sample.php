...
try{
    ...
    $sql = "INSERT INTO `register`(`experience_years`, 'Sub_Ob', `rotation`, `player_id`, `x_coordinate`, `y_coordinate`) VALUES (1,4, $rotation_counter, $player_number, $player0_x, $player0_y)";
    $stmt = $dbh->query($sql);
