...
csvname = ['1/anzai_hinata/anzai_hinata_220614_01.csv', '1/anzai_hinata/anzai_hinata_220617_03.csv', '1/anzai_hinata/anzai_hinata_220620_02.csv',
           '1/anzai_hinata/anzai_hinata_220627_01(2).csv', '1/anzai_hinata/anzai_hinata_220627_01.csv', '1/anzai_hinata/anzai_hinata_220627_02(2).csv', '1/anzai_hinata/anzai_hinata_220627_02.csv', '1/anzai_hinata/anzai_hinata_220628_03(2).csv', '1/anzai_hinata/anzai_hinata_220628_03.csv']  # 安西-西根
...
for i, filename in enumerate(csvname):
    ...
    for j in range(len(df)):
        if(movie_categotrize[0][0] == None):
            ...
            cur.execute(
                sql, (counter, df["stop_time"][j], df["movie_path"][j]))
            conn.commit()
        else:
            sql = "INSERT INTO `movie`(`movie_categorize`, `stop_time`, `movie_path`) VALUES (%s, %s, %s)"
            cur.execute(
                sql, (movie_categotrize[0][0] + counter, df["stop_time"][j], df["movie_path"][j]))
            conn.commit()
