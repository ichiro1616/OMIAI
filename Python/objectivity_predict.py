...
for j,csvname in enumerate(pattern):
    ...
    for k,link in enumerate(df_test_pattern):
        ...
        X_train = train
        y_train = y
        # np.savetxt('normalize.csv',test,delimiter=',')
        ...
        # lr = LogisticRegressionCV(C = 100, random_state=123, class_weight =None, fit_intercept = True, intercept_scaling = 1, penalty='l2',solver='lbfgs',  max_iter=100, tol = 0.0001, multi_class='auto')
        ...
        # print(mean['players_sabun_x'], mean['players_sabun_y'], mean['player1_ball_sabun_x'], mean['player1_ball_sabun_y'], mean['player2_ball_sabun_x'], mean['player2_ball_sabun_y'])
        # print(std['players_sabun_x'], std['players_sabun_y'], std['player1_ball_sabun_x'], std['player1_ball_sabun_y'], std['player2_ball_sabun_x'], std['player2_ball_sabun_y'])
