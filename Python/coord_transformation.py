...
def transformation(csv, filename, path):
    ...
    for index, row in csv.iterrows():
        ...
        if index == 0:
            ...
            b = np.array([(-row['offset_usiro_x'] + Cx1) * tz1, (-row['offset_usiro_y'] + Cy1) * tz1 + (row['offset_yoko_y'] - Cy2) * tz2, (row['offset_yoko_x'] - Cx2) * tz2])    
        ...
        b = np.array([(-row['usiro_x'] + Cx1) * tz1, (-row['usiro_y'] + Cy1) * tz1 + (row['yoko_y'] - Cy2) * tz2, (row['yoko_x'] - Cx2) * tz2])    #
